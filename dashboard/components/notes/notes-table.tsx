...
export function NotesTable({
  ...
  // Memoize filtered and sorted notes to prevent recalculation on every render
  ...
  }, [notes, filters, sortField, sortDirection]);

  // Memoize note types to prevent recalculation on every render
  const noteTypes = useMemo(() =>
    [...new Set(notes.map((n) => getNoteType(n)).filter(Boolean))],
    [notes]
  );
